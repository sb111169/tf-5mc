//  RMSprop替换 adaGrad  GloVe: Global Vectors for Word Representation
//
...
real eta = 0.001; //默认0.05 Initial learning rate
...
void *glove_thread(void *vid) {
    ...
    for (a = 0; a < lines_per_thread[id]; a++) {
        ...
        for (b = 0; b < vector_size; b++) {
            ...
            W_updates1[b] = temp1 * eta / sqrt(gradsq[b + l1]+e);
            W_updates2[b] = temp2 * eta/ sqrt(gradsq[b + l2]+e);
            ...
            gradsq[b + l1] = pl1*gradsq[b + l1]+(1-pl1) * temp1 * temp1;   //RMSprop法
            //gradsq[b + l2] += temp2 * temp2;
            gradsq[b + l2] = pl2*gradsq[b + l2]+(1-pl2) * temp2 * temp2;    //RMSprop法
        }
